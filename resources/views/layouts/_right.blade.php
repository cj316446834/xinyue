...
<div class="ww_paper_right">
    ...
    <div class="ww_member">
        <ul>
            <li onMouseOver="this.className='member_m'" onMouseOut="this.className=''"><a href="#" target="_blank" class="suburl">我的资料</a></li>
            ...
            <li onMouseOver="this.className='member_m'" onMouseOut="this.className=''"><a href="#" target="_blank" class="suburl">完善资料</a></li>
